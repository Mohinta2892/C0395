...
class Trainer(object):
    ...
    def shuffle(input_dataset, target_dataset):
        ...
        #                       ** START OF YOUR CODE **
        #######################################################################
        randomised_dataset_index = np.arange(len(input_dataset))
        np.random.shuffle(randomised_dataset_index)
        input_dataset = input_dataset[randomised_dataset_index]
        target_dataset = target_dataset[randomised_dataset_index]
    ...
    def train(self, input_dataset, target_dataset):
        ...
        for i in range(self.nb_epoch):
            training_loss = []
            n_training_batches = input_dataset.shape[0] // self.batch_size
    ...
    def eval_loss(self, input_dataset, target_dataset):
        ...
        #                       ** START OF YOUR CODE **
        #######################################################################
        y_net_outputs= self.network(input_dataset)
		
        if self.loss_fun == 'cross_entropy':
            y_predicted = CrossEntropyLossLayer.softmax(y_net_outputs)
            loss = self._loss_layer.forward(y_predicted,target_dataset)
        elif self.loss_fun == 'mse':
            loss = self._loss_layer.forward(y_net_outputs,target_dataset)
...
class Preprocessor(object):
    ...
    def __init__(self, data):
        ...
        #                       ** START OF YOUR CODE **
        #######################################################################
        self.maximum_x = np.max(data,axis=0) #axis = 0 across rows, covers all rows for each column
        self.minimum_x = np.min(data,axis=0)
    ...
    def apply(self, data):
        ...
        #                       ** START OF YOUR CODE **
        #######################################################################
        return (data-self.minimum_x) / (self.maximum_x -self.minimum_x)
    ...
    def revert(self, data):
        ...
        #                       ** START OF YOUR CODE **
        #######################################################################
        return data *(self.maximum_x -self.minimum_x) + self.minimum_x
