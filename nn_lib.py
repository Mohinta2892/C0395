...
class Trainer(object):
    ...
    def shuffle(input_dataset, target_dataset):
        ...
        #                       ** START OF YOUR CODE **
        #######################################################################
        randomised_data_index = np.arange(len(input_dataset))
        np.random.shuffle(randomised_data_index)
        input_dataset_random = input_dataset[randomised_data_index]
        target_dataset_random = target_dataset[randomised_data_index]
        return input_dataset_random,target_dataset_random
        #######################################################################
        #                       ** END OF YOUR CODE **
        #######################################################################
    ...
    def train(self, input_dataset, target_dataset):
        ...
        for i in range(self.nb_epoch):
            ...
            for j in range(n_training_batches):
                ...
                y_test = target_dataset[j*self.batch_size:(j+1)*self.batch_size]
                y_output = self.network(x_train)
                if self.loss_fun == 'mse':
                    loss = self._loss_layer.forward(y_output,y_test)
    ...
    def eval_loss(self, input_dataset, target_dataset):
        ...
        if self.loss_fun == 'mse':
            ...
            y_predicted = CrossEntropyLossLayer.softmax(y_output)
...
class Preprocessor(object):
    ...
    def __init__(self, data):
        ...
        #                       ** START OF YOUR CODE **
        #######################################################################
        self.maximum_x = np.max(data,axis=0)
